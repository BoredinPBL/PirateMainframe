...
(cl:defmethod cl:initialize-instance :after ((m <DriveCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DriveCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name piratemainframe-msg:<DriveCmd> is deprecated: use piratemainframe-msg:DriveCmd instead.")))

(cl:ensure-generic-function 'Lwheel-val :lambda-list '(m))
(cl:defmethod Lwheel-val ((m <DriveCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader piratemainframe-msg:Lwheel-val is deprecated.  Use piratemainframe-msg:Lwheel instead.")
  (Lwheel m))

(cl:ensure-generic-function 'Rwheel-val :lambda-list '(m))
(cl:defmethod Rwheel-val ((m <DriveCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader piratemainframe-msg:Rwheel-val is deprecated.  Use piratemainframe-msg:Rwheel instead.")
  (Rwheel m))
